  ...
  routes:[   //注意 写routes不是router
         ...
         {path:'/first',component:zi_first,    //如果有子路由name是写在子路由里的
            children:[
               ...
               {path:'second',name:'Home-First-Second',component:firstSencond,alias:'/gogo'},
               // {path:'second',name:'Home-First-Second',component:firstSencond,alias:['/gogo','papa']},
    ...
    template:`
           <div id='r'>
             ...
             <ol>
               ...
               <li><router-link to='/bbb/001'>bbb/001</router-link></li>
             </ol> 
