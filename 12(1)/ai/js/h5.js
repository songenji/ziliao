...
/*首屏开门*/
	...
	$men.on('transitionEnd webkitTransitionEnd',function(ev){
		$ren.css("transform","scale(1.5)");
		$ren.css("transition","3s");
		$ren.css("opacity","1");
...
loadimg()
function loadimg(){
	var arr=["left.png","music.png","right.png","t1.png","t6.png","t7.png","t8.png","t9.png","t10.png","t11.png","t12.png","t13.png","t14.png","t15.png","t16.png","t17.png","t18.png","t19.png","t20.png","t21.png","t22.png","t23.png","t24.png","t25.png","t26.png","t27.png","t28.png","t29.png","t30.png","t31.png","t32.png","t33.png","t34.png","t36.png","t37.png","t39.png","t40.png","t41.png","t42.png","t43.png","t44.png","t45.png","t46.png","t47.png","t48.png","t49.png"];
	var iNow=0;
...
/*动画一*/
	{
	  inAn:function(){
		  var $love = $li.eq(0).children(".li1Child").children('li').eq(6);
		  var $hehu = $li.eq(0).children(".li1Child").children('li').eq(0);
		  var $ai = $li.eq(0).children(".li1Child").children('li').eq(1);
		  var $jiaren = $li.eq(0).children(".li1Child").children('li').eq(2);
		  var $shu = $li.eq(0).children(".li1Child").children('li').eq(3);
		  var $daxin = $li.eq(0).children(".li1Child").children('li').eq(4);
		  var $xiaoxin = $li.eq(0).children(".li1Child").children('li').eq(5);
		  var $bipaofu1 = $li.eq(0).children(".li1Child").children('li').eq(7);
		  var $tinglong1 = $li.eq(0).children(".li1Child").children('li').eq(8);
		  ...
		  $hehu.on('transitionEnd webkitTransitionEnd',function(){
			   $ai.css('opacity',1);
			   $ai.css("transition","0.5s");
			   $ai.attr("class","ai1");
			  });
		  $ai.on('transitionEnd webkitTransitionEnd',function(){
			   $shu.css('opacity',1);
	  ...
	  outAn:function(){
		  ...
		  $shu.attr("class","");
					...
					{
		  inAn:function(){
			var $zheyitian4 = $li.eq(1).children(".li4Child").children('li').eq(0); 
			var $xinfu4 = $li.eq(1).children(".li4Child").children('li').eq(1);
			var $huoban4 = $li.eq(1).children(".li4Child").children('li').eq(2);
			var $shu4 = $li.eq(1).children(".li4Child").children('li').eq(3);
			var $daxin4 = $li.eq(1).children(".li4Child").children('li').eq(4);
			var $xiaoxin4 = $li.eq(1).children(".li4Child").children('li').eq(5);
			var $xuehua=$list.children("li").eq(1).children(".overxue").children(".xuehua");
			
			 $xuehua.css("transition","10s");
			     $xuehua.addClass("downxue");
			
			
			
			$huoban4.css("transition","1.5s");
			$huoban4.css('opacity',1);
			$huoban4.css('transform','translate(0,0)');
			$huoban4.on('transitionEnd webkitTransitionEnd',function(){
			...
			$xiaoxin4.on('transitionEnd webkitTransitionEnd',function(){
				$daxin4.addClass("daxin4move4");
				$xiaoxin4.addClass("xiaoxin4move4");
				
				$zheyitian4.css('opacity',1);
				$zheyitian4.css("transition","0.5s");
				$zheyitian4.attr("class","zheyitian4wz4");
				});
			 $zheyitian4.on('transitionEnd webkitTransitionEnd',function(){
				$xinfu4.css('opacity',1);
				$xinfu4.css("transition","0.5s");
				$xinfu4.attr("class","xinfu4wz4");
				 });
			 $xinfu4.on('transitionEnd webkitTransitionEnd',function(){
				 $shu4.css('opacity',1);
				 $shu4.css("transition","1s");
			     $shu4.attr("class","shu44yid");
				
				 
				 });
			 $shu4.on('transitionEnd webkitTransitionEnd',function(){
				 $shu4.addClass("shu4move44");
		  ...
		  outAn:function(){
			...
			$li.eq(1).children(".li4Child").children('li').css('opacity',0);
			$huoban4.css("transition","");
			$huoban4.css('transform','translate(0,200px)');
			$daxin4.css("transition","");
			$daxin4.attr("class","");
			$xiaoxin4.css("transition","");
			$xiaoxin4.attr("class","");
			
			$zheyitian4.css("transition","");
			$zheyitian4.attr("class","");
			$xinfu4.css("transition","");
			$xinfu4.attr("class","");
			
			$shu4.css("transition","");
			$shu4.attr("class","");
			
			$xuehua.css("transition","");
			$xuehua.removeClass("downxue")
			}
		},
	...
	/*动画二*/
	 {
		  inAn:function(){
		   var $leftyun = $li.eq(2).children(".li2Child").children('li').eq(0);
		   var $rightyun = $li.eq(2).children(".li2Child").children('li').eq(1);
		   var $qizi = $li.eq(2).children(".li2Child").children('li').eq(2);
		   var $jinxiwz = $li.eq(2).children(".li2Child").children('li').eq(3);
		   var $fangxiawz = $li.eq(2).children(".li2Child").children('li').eq(4);
		   var $kaishiwz = $li.eq(2).children(".li2Child").children('li').eq(5);
		   var $qingyun = $li.eq(2).children(".li2Child").children('li').eq(6);
		   var $shu2 = $li.eq(2).children(".li2Child").children('li').eq(7);
		   var $daxin2 = $li.eq(2).children(".li2Child").children('li').eq(8);
		   var $xiaoxin2 = $li.eq(2).children(".li2Child").children('li').eq(9);
		   ...
		   $xiaoxin2.on('transitionEnd webkitTransitionEnd',function(){
			...
			$jinxiwz.on('transitionEnd webkitTransitionEnd',function(){
			   $fangxiawz.css("transition","0.5s");
			   $fangxiawz.css('opacity',1);
		       $fangxiawz.attr("class","fangxiawz2");
			 });
			$fangxiawz.on('transitionEnd webkitTransitionEnd',function(){
			   $kaishiwz.css("transition","0.5s");
			   $kaishiwz.css('opacity',1);
		       $kaishiwz.attr("class","kaishiwz2");
				});
		   $kaishiwz.on('transitionEnd webkitTransitionEnd',function(){
			    $shu2.css('opacity',1);
		  ...
		  outAn:function(){
		   ...
		   var $daxin2 = $li.eq(2).children(".li2Child").children('li').eq(8);
		   var $xiaoxin2 = $li.eq(2).children(".li2Child").children('li').eq(9);
		   $li.eq(2).children(".li2Child").children('li').css('opacity',0);
		   ...
		   $jinxiwz.attr("class","");
		   $fangxiawz.css("transition","");
		   $fangxiawz.attr("class","");
		   $kaishiwz.css("transition","");
		   $kaishiwz.attr("class","");
		...
		{
		  inAn:function(){
		  var $jhb7=$li.eq(3).children(".li7Child").children('li').eq(0);
		  var $leftyun7=$li.eq(3).children(".li7Child").children('li').eq(1);
		  var $rightyun7=$li.eq(3).children(".li7Child").children('li').eq(2);
		  var $jhren7=$li.eq(3).children(".li7Child").children('li').eq(3);
		  var $daxin7=$li.eq(3).children(".li7Child").children('li').eq(4);
		  var $xiaoxin7=$li.eq(3).children(".li7Child").children('li').eq(5);
		  var $wenzi7=$li.eq(3).children(".li7Child").children('li').eq(6);
		  var $shu7=$li.eq(3).children(".li7Child").children('li').eq(7);
		 ...
		 $shu7.on('transitionEnd webkitTransitionEnd',function(){
		  ...
		  var $wenzi7=$li.eq(3).children(".li7Child").children('li').eq(6);
		  var $shu7=$li.eq(3).children(".li7Child").children('li').eq(7);
		  $li.eq(3).children(".li7Child").children('li').css('opacity',0);
        ...
        {
		 inAn:function(){
			var $gechangzai5 = $li.eq(4).children(".li5Child").children('li').eq(0);
			var $bigai5 = $li.eq(4).children(".li5Child").children('li').eq(1);
			var $xiageipenyou5 = $li.eq(4).children(".li5Child").children('li').eq(2);
			var $dadi5 = $li.eq(4).children(".li5Child").children('li').eq(3); 
			var $jiehun5 = $li.eq(4).children(".li5Child").children('li').eq(4);
			var $daxin5 = $li.eq(4).children(".li5Child").children('li').eq(5);
			var $xiaoxin5 = $li.eq(4).children(".li5Child").children('li').eq(6);
			var $shu5 = $li.eq(4).children(".li5Child").children('li').eq(7);
			...
			$bigai5.on('transitionEnd webkitTransitionEnd',function(){
				$xiageipenyou5.css('opacity',1);
				$xiageipenyou5.css("transition","0.5s");
				$xiageipenyou5.attr("class","bigai5wz5");
				});
			$xiageipenyou5.on('transitionEnd webkitTransitionEnd',function(){
				$shu5.css('opacity',1);
		 ...
		 outAn:function(){
			...
			$bigai5.attr("class","");
			$xiageipenyou5.css("transition","");
			$xiageipenyou5.attr("class","");
			$shu5.css("transition","");
			$shu5.attr("class","");
			 }
		},
		...
		{
		  inAn:function(){
			 var $zuoyun3 = $li.eq(5).children(".li3Child").children('li').eq(0);	
			 var $centeryun3 = $li.eq(5).children(".li3Child").children('li').eq(1);
			 var $youyun3 = $li.eq(5).children(".li3Child").children('li').eq(2);	
			 var $ganenxin3 = $li.eq(5).children(".li3Child").children('li').eq(3);	
			 var $cikekaishi3 = $li.eq(5).children(".li3Child").children('li').eq(4);	
			 var $laoren3 = $li.eq(5).children(".li3Child").children('li').eq(5);
			 var $daxue3 = $li.eq(5).children(".li3Child").children('li').eq(6);
			 var $xiaoxue3 = $li.eq(5).children(".li3Child").children('li').eq(7);	
			 var $xiaoxuetwo3 = $li.eq(5).children(".li3Child").children('li').eq(8);
			 var $shu3 = $li.eq(5).children(".li3Child").children('li').eq(9);	
			 var $daxin3 = $li.eq(5).children(".li3Child").children('li').eq(10);
			 var $xiaoxin3 = $li.eq(5).children(".li3Child").children('li').eq(11);	
			...
			$xiaoxuetwo3.on('transitionEnd webkitTransitionEnd',function(){
			 ...
			 $xiaoxin3.on('transitionEnd webkitTransitionEnd',function(){
			  ...
			  $ganenxin3.on('transitionEnd webkitTransitionEnd',function(){
				   $cikekaishi3.css('opacity',1);
				   $cikekaishi3.css("transition","0.5s");
				   $cikekaishi3.attr("class","cikekaishi3wz3");
				  });
			  $cikekaishi3.on('transitionEnd webkitTransitionEnd',function(){
				   $shu3.css('opacity',1);
		  ...
		  outAn:function(){
			 ...
			 var $daxin3 = $li.eq(5).children(".li3Child").children('li').eq(10);
			 var $xiaoxin3 = $li.eq(5).children(".li3Child").children('li').eq(11);	
			 $li.eq(5).children(".li3Child").children('li').css('opacity',0);
			 ...
			 $cikekaishi3.css("transition","");
			 $cikekaishi3.attr("class","");
			 $shu3.css("transition","");
			 $shu3.attr("class","");
		...
		{
		 inAn:function(){
			 var $topaixin6 = $li.eq(6).children(".li6Child").children('li').eq(0); 
			 var $leftyun6 = $li.eq(6).children(".li6Child").children('li').eq(1); 
			 var $rightyun6 = $li.eq(6).children(".li6Child").children('li').eq(2);
			 var $denglong6 = $li.eq(6).children(".li6Child").children('li').eq(3); 
			 var $dadan6 = $li.eq(6).children(".li6Child").children('li').eq(4); 
			 var $jiansu6 = $li.eq(6).children(".li6Child").children('li').eq(5);
			 var $juban6 = $li.eq(6).children(".li6Child").children('li').eq(6);
			 var $huodong6 = $li.eq(6).children(".li6Child").children('li').eq(7); 
			 var $mianfei6 = $li.eq(6).children(".li6Child").children('li').eq(8);
			 var $leftzp6 = $li.eq(6).children(".li6Child").children('li').eq(9);
			 var $centerzp6 = $li.eq(6).children(".li6Child").children('li').eq(10);
			 var $rightzp6 = $li.eq(6).children(".li6Child").children('li').eq(11); 
			 ...
			 $mianfei6.on('transitionEnd webkitTransitionEnd',function(){
				 ...
				 $centerzp6.css("transition","1s");
			     $centerzp6.css('transform','translate(0,0)');
				 });
			  $centerzp6.on('transitionEnd webkitTransitionEnd',function(){
				 $leftzp6.css('opacity',1);
				 $rightzp6.css('opacity',1);
				 $leftzp6.css("transition","0.6s");
			     $leftzp6.css('transform','translate(0,0)');
				 $rightzp6.css("transition","0.6s");
			     $rightzp6.css('transform','translate(0,0)');
				  });
			 },
		 outAn:function(){
			 var $topaixin6 = $li.eq(6).children(".li6Child").children('li').eq(0); 
			 ...
			 var $centerzp6 = $li.eq(6).children(".li6Child").children('li').eq(10);
			 var $rightzp6 = $li.eq(6).children(".li6Child").children('li').eq(11); 
			 $li.eq(6).children(".li6Child").children('li').css('opacity',0);
			 ...
			 $rightzp6.css("transition","");
			 $rightzp6.css('transform','translate(100px,0)');
			 }	
		}
];
