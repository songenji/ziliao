	...
	/*动画二*/
	 {
		...
		},
		{
		 inAn:function(){
			 ...
			 var $rightzp6 = $li.eq(5).children(".li6Child").children('li').eq(12);
			 var $erwema6 = $li.eq(5).children(".li6Child").children('li').eq(11); 
			 ...
			 $mianfei6.on('transitionEnd webkitTransitionEnd',function(){
			  ...
			  $centerzp6.on('transitionEnd webkitTransitionEnd',function(){
				 $erwema6.css("transition","0.6s");
			     $erwema6.css('transform','translate(0,0)');
			     $erwema6.css('opacity',1); 
		 ...
		 outAn:function(){
			 ...
			 $centerzp6.css('transform','translate(100px,0)');
			 $leftzp6.css("transition","");
			 $leftzp6.css('transform','translate(-100px,0)');
			 $rightzp6.css("transition","");
			 $rightzp6.css('transform','translate(0,100px)');
			 $erwema6.css("transition","");
			 $erwema6.css('transform','translate(0,100px)');
			 }	
		}
];
